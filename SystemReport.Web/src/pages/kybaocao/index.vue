...
export default {
  ...
  watch: {
    ...
    showModal(status) {
      if (status == false) this.model = kyBaoCaoModel.baseJson();
    },
    showDeleteModal(val) {
      if (val == false) {
        this.model.id = null;
  ...
  methods: {
    ...
    async handleUpdate(id) {
      await this.$store.dispatch("kyBaoCaoStore/getById", id).then((res) => {
        if (res.resultCode === 'SUCCESS') {
          this.model = kyBaoCaoModel.fromJson(res.data);
          this.showModal = true;
        } else {
    ...
    async handleDelete() {
      if (this.model.id != 0 && this.model.id != null && this.model.id) {
        await this.$store.dispatch("kyBaoCaoStore/delete", this.model.id).then((res) => {
          if (res.resultCode === 'SUCCESS') {
            this.fnGetList();
    ...
    async handleSubmit(e) {
      ...
      if (this.$v.$invalid) {
        ...
        if (
          ...
          // Update model
          await this.$store.dispatch("kyBaoCaoStore/update", this.model).then((res) => {
            if (res.resultCode === 'SUCCESS') {
              this.fnGetList();
          ...
          // Create model
          await this.$store.dispatch("kyBaoCaoStore/create", kyBaoCaoModel.toJson(this.model)).then((res) => {
            if (res.resultCode === 'SUCCESS') {
              this.fnGetList();
              this.showModal = false;
              this.$refs.tblList.refresh()
    ...
    myProvider (ctx) {
      ...
      this.loading = true
      try {
        let promise =  this.$store.dispatch("kyBaoCaoStore/getPagingParams", params)
              ...
              <div class="col-sm-8">
                <div class="text-sm-end">
                  <b-button
                      ...
                      size="sm"
                  >
                    <i class="mdi mdi-plus me-1"></i> Tạo Kỳ báo cáo
                  </b-button>
                  <b-modal
                      v-model="showModal"
                  ...
                  >
                    <form @submit.prevent="handleSubmit"
                      ...
                      <div class="row">
                        <div class="col-12">
                          <div class="mb-3">
                            <label class="text-left">Mã kỳ báo cáo</label>
                            ...
                            <input
                                ...
                                type="text"
                                class="form-control"
                                placeholder="Nhập mã kỳ báo cáo"
                                :class="{
                                'is-invalid':
                            ...
                            >
                              Tên mã báo cáo không được để trống.
                            </div>
                          </div>
                        </div>
                        <div class="col-12">
                          <div class="mb-3">
                            <label class="text-left">Tên Kỳ báo cáo</label>
                            <span style="color: red">&nbsp;*</span>
                            ...
                            <div
                                ...
                                class="invalid-feedback"
                            >
                              Tên Kỳ báo cáo không được để trống.
                            </div>
                          </div>
                        </div>
                        <div class="col-6">
                          <div class="mb-3">
                            <label class="text-left">Loại ký báo cáo</label>
                            <br />
                            <switches v-model="model.loaiKyBaoCao" type-bold="false" color="info" class="mt-2"></switches>
                          </div>
                        </div>
                        <div class="col-6">
                          <div class="mb-3">
                  ...
                  <b-modal
                      v-model="showDetail"
                      title="Thông tin chi tiết Kỳ báo cáo"
                      title-class="text-black font-18"
                      body-class="p-3"
                      hide-footer
                      centered
              ...
              <div class="col-12">
                ...
                <div class="table-responsive-sm">
                  ...
                  >
                    ...
                    <template v-slot:cell(loaiKyBaoCao)="data">
                      <div v-if="data.item.loaiKyBaoCao == 'nam'">
                        Năm
                      </div>
                      <div v-else-if="data.item.loaiKyBaoCao == 'thang'">Tháng
                      </div>
                      <div v-else>
                        Giai đoạn
                      </div>
