                ...
                <div class="table-responsive-sm">
                  ...
                  >
                    ...
                    <template v-slot:cell(status)="data">
                      <b-button
                          v-if=" data.item.lastStatus && (data.item.lastStatus.code == 'KT' || data.item.lastStatus.code == 'CBTHTC')"
                          type="button"
                          size="sm"
                                    ...
                                    <div class="col-12 ">
                                      <div class="card   p-3" v-for="(value, index) in data.item.bangBieus" :key="index">
                                        <div class="card-body">
                                          ...
                                          <p> </p>
                                          <a v-if="data.item.lastStatus && (data.item.lastStatus.code == 'KT')" href="javascript:void(0);" @click="handleThucHienNhapLieu(value.id)" class="btn btn-primary btn-block me-1" size="sm">   <i class="mdi mdi-circle-edit-outline me-1"></i> Nhập liệu</a>
...
export default {
  ...
  methods: {
    ...
    myProvider (ctx) {
      ...
      this.loading = true
      try {
        let promise =  this.$store.dispatch("mauBieuStore/getPagingParamsKiemTra", params)
...
@media only screen and (max-width: 768px) {
  ...
  Label the data
  */
  .b-table-kiemtra>td:nth-of-type(1):before{
    content: "STT";
    font-weight: bold;
    color: #00568c;
  }
  .b-table-kiemtra>td:nth-of-type(2):before {
    content: "Ký hiệu";
    font-weight: bold;
    color: #00568c;
  }
  .b-table-kiemtra>td:nth-of-type(3):before {
    content: "Tên mẫu biểu";
    font-weight: bold;
    color: #00568c;
  }
  .b-table-kiemtra>td:nth-of-type(4):before {
    content: "Loại mẫu biểu";
    font-weight: bold;
    color: #00568c;
  }
  .b-table-kiemtra>td:nth-of-type(5):before {
    content: "Kỳ báo cáo";
    font-weight: bold;
    color: #00568c;
  }
  .b-table-kiemtra>td:nth-of-type(6):before {
    content: "Trạng thái";
    font-weight: bold;
    color: #00568c;
  }
  .b-table-kiemtra>td:nth-of-type(7):before {
    content: "";
    font-weight: bold;
    color: #00568c;
  }
  .b-table-kiemtra>td:nth-of-type(8):before {
    content: "";
    font-weight: bold;
    color: #00568c;
  }
}
.b-table-kiemtra:hover{
  background: #ddd !important;
  position: relative;
  z-index: 99;
  --bs-table-accent-bg: #ddd;
}
.table-striped > tbody > .b-table-kiemtra:nth-of-type(odd):hover{
  --bs-table-accent-bg: #ddd;
}
