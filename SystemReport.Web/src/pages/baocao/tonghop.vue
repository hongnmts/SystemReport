                ...
                <div class="table-responsive-sm">
                  ...
                  >
                    ...
                    <template v-slot:cell(status)="data">
                      <b-button
                          v-if=" data.item.lastStatus && (data.item.lastStatus.code == 'TH' || data.item.lastStatus.code == 'LDSTC' )"
                          type="button"
                          size="sm"
...
export default {
  ...
  methods: {
    ...
    myProvider (ctx) {
      ...
      this.loading = true
      try {
        let promise =  this.$store.dispatch("mauBieuStore/getPagingParamsTongHop", params)
