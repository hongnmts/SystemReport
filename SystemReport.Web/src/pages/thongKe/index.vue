              ...
              <div class="col-12">
                ...
                <div class="table-responsive-sm">
                  <b-table
                      ...
                      primary-key="id"
                      :busy.sync="isBusy"
                      tbody-tr-class="b-table-xuatban"
                  >
                    ...
                    <template v-slot:cell(status)="data">
                      <b-button
                          v-if=" data.item.lastStatus && (data.item.lastStatus.code == 'TLDS' || data.item.lastStatus.code == 'XB' || data.item.lastStatus.code == 'LHNB' || data.item.lastStatus.code == 'THO') "
                          type="button"
                          size="sm"
                                ...
                                <div class="col-12">
                                  ...
                                  <div class="table-responsive-sm">
                                    <b-table
                                        ...
                                        tbody-tr-class="b-table-banhanh"
                                    >
                                      <template v-slot:cell(STT)="data">
...
export default {
  ...
  methods: {
    ...
    handleXemBangBieu(id){
      if(id){
        this.$router.push("/bang-bieu-thong-ke/" + id)
      }
