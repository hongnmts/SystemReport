...
<!--                &lt;!&ndash;                    v-model="paramMauBieu.kyBaoCao"&ndash;&gt;-->
<!--                &lt;!&ndash;                    :options="optionKyBaoCao"&ndash;&gt;-->
<!--                &lt;!&ndash;                    track-by="id"&ndash;&gt;-->
<!--                &lt;!&ndash;                    label="ten"&ndash;&gt;-->
<!--                &lt;!&ndash;                    placeholder="Chọn loại ký báo cáo"&ndash;&gt;-->
<!--                &lt;!&ndash;                    deselect-label="Nhấn để xoá"&ndash;&gt;-->
<!--                &lt;!&ndash;                    selectLabel="Nhấn enter để chọn"&ndash;&gt;-->
<!--                &lt;!&ndash;                    selectedLabel="Đã chọn"&ndash;&gt;-->
<!--                &lt;!&ndash;                    class="mb-2"&ndash;&gt;-->
<!--                &lt;!&ndash;                ></multiselect>&ndash;&gt;-->

<!--              </div>-->
<!--              &lt;!&ndash;              <template v-if="paramMauBieu.kyBaoCao != '' && paramMauBieu.kyBaoCao != null && paramMauBieu.kyBaoCao != undefined">&ndash;&gt;-->
<!--              &lt;!&ndash;                <div class="col-3 "  v-if="paramMauBieu.kyBaoCao && paramMauBieu.kyBaoCao.loaiKyBaoCao == 'nam'">&ndash;&gt;-->
<!--              &lt;!&ndash;                  <label class="form-label"> Thời gian</label>&ndash;&gt;-->
<!--              &lt;!&ndash;                  <br />&ndash;&gt;-->
<!--              &lt;!&ndash;                  <date-picker&ndash;&gt;-->
<!--              &lt;!&ndash;                      v-model="paramMauBieu.nam"&ndash;&gt;-->
<!--              &lt;!&ndash;                      type="year"&ndash;&gt;-->
<!--              &lt;!&ndash;                      lang="vi"&ndash;&gt;-->
<!--              &lt;!&ndash;                      placeholder="Chọn năm"&ndash;&gt;-->
<!--              &lt;!&ndash;                  ></date-picker>&ndash;&gt;-->
<!--              &lt;!&ndash;                </div>&ndash;&gt;-->
<!--              &lt;!&ndash;                <div v-else class="col-6">&ndash;&gt;-->
<!--              &lt;!&ndash;                  <label class="form-label"> Thời gian</label>&ndash;&gt;-->
<!--              &lt;!&ndash;                  <br />&ndash;&gt;-->
<!--              &lt;!&ndash;                  <div style="display: flex;">&ndash;&gt;-->
<!--              &lt;!&ndash;                    <multiselect&ndash;&gt;-->
<!--              &lt;!&ndash;                        :multiple="false"&ndash;&gt;-->
<!--              &lt;!&ndash;                        v-model="paramMauBieu.thang"&ndash;&gt;-->
<!--              &lt;!&ndash;                        :options="thangModel"&ndash;&gt;-->
<!--              &lt;!&ndash;                        track-by="id"&ndash;&gt;-->
<!--              &lt;!&ndash;                        label="name"&ndash;&gt;-->
<!--              &lt;!&ndash;                        placeholder="Chọn tháng"&ndash;&gt;-->
<!--              &lt;!&ndash;                        deselect-label="Nhấn để xoá"&ndash;&gt;-->
<!--              &lt;!&ndash;                        selectLabel="Nhấn enter để chọn"&ndash;&gt;-->
<!--              &lt;!&ndash;                        selectedLabel="Đã chọn"&ndash;&gt;-->
<!--              &lt;!&ndash;                        class="mb-2"&ndash;&gt;-->
...
<!--              &lt;!&ndash;                        type="year"&ndash;&gt;-->
<!--              &lt;!&ndash;                        lang="en"&ndash;&gt;-->
<!--              &lt;!&ndash;                        placeholder="Chọn tháng năm"&ndash;&gt;-->
<!--              &lt;!&ndash;                    ></date-picker>&ndash;&gt;-->
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-body">
            ...
            >
              <i class="mdi mdi-plus me-1"></i> Xuất báo cáo
            </b-button>
            <b-button
                variant="primary"
                type="button"
            ...
            >
              <i class="mdi mdi-plus me-1"></i> Tiêu chí thống kê
            </b-button>
...
<!--    Tiêu chí-->
    ...
    >
      <div class="d-flex justify-content-between align-items-center mb-3">
        <p class="fw-bold">Tiêu chí thống kê</p>
        <b-button
            ...
            style="margin-bottom: 10px; margin-left: 10px"
        >
          <i class="mdi mdi-plus me-1"></i> Xử lý
        </b-button>
        <b-button pill v-b-modal.modal-close_visit size="sm" class=""
                  v-on:click="showModalTieuChi = false">
          <i class="fas fa-times mx-1"></i>
        </b-button>
      </div>
      <div class="row">
        <div class="col-12 text-center">
          <v-jstree :data="treeView" show-checkbox size="large"  multiple allow-batch @item-click="itemClick"   :item-events="itemEvents"  ></v-jstree>
        </div>
...
export default {
  ...
  created() {
    ...
    // this.getKyBaoCao();
    this.GetTreeList();
    this.handleXemBangBieu(this.$route.params.id);
  },
  watch: {
    modelInputMauBieu:{
      deep: true,
  ...
  methods: {
    async GetBangBieu(){
      await this.$store.dispatch("thongKeStore/getBangBieu", {id: this.$route.params.id, value: this.tieuChis}).then((res) => {
        if(res.data){
          console.log("------------", res.data);
          this.renderMainRowValue = res.data.body;
          this.headers = res.data.headers;
          this.showModalTieuChi = false;
        }

      })
    },
    async GetTreeList(){
      await this.$store.dispatch("thongKeStore/getTieuChi", this.$route.params.id).then((res) => {
        if(res.data){
          this.treeView = res.data.tieuChiView;
          this.tieuChis = res.data.tieuChis;
        }

      })
    },
    async itemClick (node) {
      this.tieuChis.map(value =>{
        if(value.id == node.model.id){
          value.selected = node.model.selected;
          if(node.model.children != null && node.model.children.length > 0){
            node.model.children.map(item =>{
              this.tieuChis.map(value1 =>{
                if(value1.id ==item.id){
                  value1.selected = item.selected;
                  return;
                }
              })
            })
    ...
    async handleTieuChi(id){
      this.showModalTieuChi = true;
    },
    ...
    myProvider (ctx) {
      ...
      this.loading = true
      try {
        let promise =  this.$store.dispatch("mauBieuStore/getPagingParamsXuatBan", params)
        return promise.then(resp => {
          if(resp.resultCode == CONSTANTS.SUCCESS){
            let data = resp.data;
...
@media only screen and (max-width: 768px) {
  ...
  .b-table-xuatban>td:nth-of-type(1):before{
    content: "STT";
    font-weight: bold;
    color: #00568c;
  }
  .b-table-xuatban>td:nth-of-type(2):before {
    content: "Ký hiệu";
    font-weight: bold;
    color: #00568c;
  }
  .b-table-xuatban>td:nth-of-type(3):before {
    content: "Tên mẫu biểu";
    font-weight: bold;
    color: #00568c;
  }
  .b-table-xuatban>td:nth-of-type(4):before {
    content: "Loại mẫu biểu";
    font-weight: bold;
    color: #00568c;
  }
  .b-table-xuatban>td:nth-of-type(5):before {
    content: "Kỳ báo cáo";
    font-weight: bold;
    color: #00568c;
  }
  .b-table-xuatban>td:nth-of-type(6):before {
    content: "Trạng thái";
    font-weight: bold;
    color: #00568c;
  }
  .b-table-xuatban>td:nth-of-type(7):before {
    content: "";
    font-weight: bold;
    color: #00568c;
  }
  .b-table-xuatban>td:nth-of-type(8):before {
    content: "";
    font-weight: bold;
    color: #00568c;
  }
...
.b-table-xuatban:hover{
  background: #ddd !important;
  position: relative;
  z-index: 99;
  --bs-table-accent-bg: #ddd;
}
.table-striped > tbody > .b-table-xuatban:nth-of-type(odd):hover{
  --bs-table-accent-bg: #ddd;
}
