  ...
  <Layout>
    ...
    <div class="row">
      ...
      <div class="col-8">
        <div class="card">
          <div class="card-body">
            <h4 class="text-success font-weight-bold font-size-18 mb-2">{{this.node.name}}</h4>
            <b-table
                class="datatables"
            ...
            <template v-slot:cell(STT)="data">
              ...
              <template v-slot:cell(process)="data">
                <div class="form-check form-check-success" style="display: flex; justify-content: center">
                  <input
