...
namespace SystemReport.WebAPI.APIs
{
    ...
    public class DonViTinhController : ControllerBase
    {
        ...
        [HttpPost]
        [Route("create")]
        public async Task<IActionResult> Create([FromBody] DonViTinh model)
        {
            try
            {
                var response = await _donViTinhService.Create(model);
                return Ok(
        ...
        [HttpPost]
        [Route("update")]
        public async Task<IActionResult> Update([FromBody] DonViTinh model)
        {
            try
            {
                var response = await _donViTinhService.Update(model);
        ...
        public async Task<IActionResult> GetById(string id)
        {
            try
            {
                var response = await _donViTinhService.GetById(id);
        ...
        public async Task<IActionResult> Get()
        {
            try
            {
                var response = await _donViTinhService.Get();
        ...
        public async Task<IActionResult> GetPagingParam([FromBody] PagingParam param)
        {
            try
            {
                var response = await _donViTinhService.GetPaging(param);
