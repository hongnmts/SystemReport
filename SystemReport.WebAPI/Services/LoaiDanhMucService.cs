...
{
    public class LoaiDanhMucService : BaseService
    {
        private DataContext _context;
        private BaseMongoDb<LoaiDanhMuc, string> BaseMongoDb;
        private IMongoCollection<LoaiDanhMuc> _collection;
        private IDbSettings _settings;
        private ILoggingService _logger;

        public LoaiDanhMucService(ILoggingService logger, IDbSettings settings, DataContext context,
            IHttpContextAccessor contextAccessor)
            : base(context, contextAccessor)
        {
            _context = context;
            BaseMongoDb = new BaseMongoDb<LoaiDanhMuc, string>(_context.LoaiDanhMuc);
            _collection = context.LoaiDanhMuc;
            _settings = settings;
            _logger = logger.WithCollectionName(_settings.LoaiDanhMucCollectionName)
        ...
        public async Task<LinhVuc> Create(LinhVuc model)
        {
            ...
            var checkName = _context.LoaiDanhMuc.Find(x => x.Ten == model.Ten && x.IsDeleted != true).FirstOrDefault();
